...
- **UI**
  - 페이지: 위시리스트 페이지
- **기능**
  - 찜 목록 추가 팝업 구현, 찜 목록 상세 확인 가능 창 구현, 서버 연결 후 정보 결과 구현
...
- **기능**
  - 카카오 API연결 후 간편 로그인 기능 구현, header와 footer의 창 이동 버튼 구현

### 🗂️주형돈
- **UI**
  - 페이지: About Us 페이지
- **기능**
  - About Us페이지 내 페이지 소개글 작성

### 🔍김동우
- **UI**
  - 페이지: 장바구니 페이지
- **기능**
  - 장바구니 목록 상세 확인 가능 창 구현, 서버 연결 후 정보 결과 구현
- **DB 관리**
...
- **UI**
  - 페이지: 주문 내역 페이지
- **기능**
  -  제품 주문 내역 상세 확인 가능 창 구현, 서버 연결 후 정보 결과 구현
...
- **UI**
  - 페이지: 상품 상세 정보 페이지
- **기능**
  - 검색결과 상세정보 창 구현, 서버 연결 후 정보 결과 구현

### 💼오혜준
- **UI**
  - 페이지: 상품 검색 결과 페이지
- **기능**
  - 검색결과 창 구현, 서버 연결 후 정보 결과 구현

### 📅김민수
- **UI**
  - 페이지: 배송지 관리 페이지
- **기능**
  - 카카오 지도API연동 후 주소지 추가 설정 구현, 서버 연결 후 주소지 정보 결과 구현
